    ...
    <div className="App">
      <div className="container">
        ...
        <div className="add-section">
          <input type="textbox" name="item-name" placeholder="Enter item name here" value={item} onChange={(event) => { setItem(event.target.value) }} />
          <button onClick={() => {
        ...
        <div className="features">
          <button onClick={() => { setFunc('onShowAllTask'); }}> Show All Tasks</button>
          <button onClick={() => { setFunc('onShowActiveTask'); }}> Show Active Tasks</button>
          <button onClick={() => { setFunc('onShowCompletedTask'); }}> Show Completed Tasks</button>
        </div>
